...
load('/partner-alerts-core-v1.js?v=20260914-vaahak-actions-v1','data-dbest-partner-alerts-core').then(()=>{if(/\/vaahak-standalone-v2\.html\/?$/i.test(location.pathname))return load('/vaahak-compact-actions-v1.js?v=20260914-vaahak-actions-v1','data-dbest-vaahak-compact-actions')}).catch(e=>console.warn('DBest partner alerts loader',e));
})();
