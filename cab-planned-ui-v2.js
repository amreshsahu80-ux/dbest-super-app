...
function patchSearch(){css();
 ...
 if(drop&&!$('dbestTripType')){
   const rt=document.createElement('div');rt.id='dbestTripType';rt.innerHTML='<div class="dbestTripType"><button type="button" class="on" data-dbest-trip="oneway">One Way</button><button type="button" data-dbest-trip="roundtrip">Round Trip</button></div><div id="dbestRoundTripNote"><b>Same vehicle round trip</b><br>Sedan ₹15/km • SUV ₹18/km • Tolls extra<br><label><input type="checkbox" id="dbestNightHalt"> Night halt (Sedan ₹1,000 / SUV ₹1,500)</label></div>';
