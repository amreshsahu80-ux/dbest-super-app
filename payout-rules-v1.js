(function(){
  ...
  window.dbestPayout=function(level,category,base,opts){
    ...
    return {level,category,base,pct,direct,uplinePct:r.upline==null?null:r.upline,uplineAmount:r.upline==null?null:base*r.upline/100};
  };
})();