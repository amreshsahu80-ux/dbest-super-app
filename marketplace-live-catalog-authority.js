(function(){
'use strict';
const VERSION='1.1.0',BUILD='20260823-0455-live-catalog-visible';
...
async function enforce(){
  ...
  try{
    ...
    // For any category backed by live Supabase catalogue, only live products are sellable.
    ...
    // Live vendors are authoritative for those same categories. This removes confusing demo vendor tabs.
    ...
    // If the user is already viewing a live Marketplace category, repaint it immediately.
