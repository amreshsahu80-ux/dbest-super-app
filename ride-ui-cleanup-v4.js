(function(){
  const style=document.createElement('style');style.textContent=`
    .dbestRideSuggestions{max-height:150px!important;overflow:auto!important;margin:4px 0 8px!important;position:static!important;box-shadow:none!important;border-radius:12px!important}
    .dbestRideSuggestion{padding:9px 11px!important;font-size:12px!important}
    ...
    .dbestVaahakList{display:flex!important;gap:7px!important;overflow:auto!important}
  ...
  async function indiaSearch(q){
    ...
    const qs=new URLSearchParams({format:'jsonv2',addressdetails:'1',countrycodes:'in',limit:'4',q});
  ...
  window.openRidePlatform=function(){const r=old&&old.apply(this,arguments);setTimeout(simplify,250);setTimeout(paintVaahaks,500);return r};
  new MutationObserver(()=>{simplify();paintVaahaks()}).observe(document.documentElement,{childList:true,subtree:true});
})();