...
function compact(){
  ...
  s.textContent=`
    ...
    @media(max-width:600px){
      .dbcgMap{height:218px!important;border-radius:23px!important}
      .dbcgCard{margin:-25px 6px 0!important;padding:12px!important;border-radius:25px!important}
      .dbcgTabs button,.dbcgSeg button{font-size:13px!important;min-height:43px!important}
      .dbcgGo{position:sticky!important;bottom:10px!important;z-index:30!important;min-height:54px!important}
    }
  `;
